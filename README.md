...
[zipped up binary]: https://github.com/weavejester/cljfmt/releases/download/0.15.4/cljfmt-0.15.4-win-amd64.zip
...
```bash
clj -Ttools install io.github.weavejester/cljfmt '{:git/tag "0.15.4"}' :as cljfmt
```
...
```clojure
:plugins [[dev.weavejester/lein-cljfmt "0.15.4"]]
```
