...
[zipped up binary]: https://github.com/weavejester/cljfmt/releases/download/0.10.3/cljfmt-0.10.3-win-amd64.zip
...
```bash
clj -Ttools install io.github.weavejester/cljfmt '{:git/tag "0.10.3"}' :as cljfmt
```
...
```clojure
:plugins [[dev.weavejester/lein-cljfmt "0.10.3"]]
```
...
```edn
{:deps {dev.weavejester/cljfmt {:mvn/version "0.10.3"}}}
```
