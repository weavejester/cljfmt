...
[zipped up binary]: https://github.com/weavejester/cljfmt/releases/download/0.15.0/cljfmt-0.15.0-win-amd64.zip
...
```bash
clj -Ttools install io.github.weavejester/cljfmt '{:git/tag "0.15.0"}' :as cljfmt
```
...
```clojure
:plugins [[dev.weavejester/lein-cljfmt "0.15.0"]]
```
...
```edn
{:deps {dev.weavejester/cljfmt {:mvn/version "0.15.0"}}}
```
